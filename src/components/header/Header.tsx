...
const Header = () => {
  ...
  return (
    <header className="flex justify-between items-center pl-11 pt-11 sm:pt-0 lg:pt-11">
      <img src={Logo} />
      ...
      <nav
        className={`sm:static sm:z-0 sm:flex sm:flex-row sm:justify-evenly sm:min-w-[450px] lg:min-w-[830px] sm:h-24 bg-white bg-opacity-5 backdrop-blur-[81.55px] tracking-[2.70px] uppercase sm:pt-0
          ${
            isOpen
